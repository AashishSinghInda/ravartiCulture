...
export default function Footer() {
  return (
        ...
        <ul>
            ...
            <li>
                    ...
                    <form className='flex gap-[10px] '>
                        <input type="email" name='' placeholder='Your email' autoFocus='none' className='border my-[10px] text-white border-white rounded p-[5px] bg-[#76303c]'  />
   ...
   <div className='max-w-[100%] py-[20px] bg-[#661926] lg:px-[40px] md:px-[20px] px-[10px] flex justify-between items-center'>
     <p className='text-[#ceb6b9] font-semibold lg:text-[15px] text-[10px]'>© 2025 RAVARTI CULTURE. All rights reserved.</p>
