...
export default function Product() {
  return (
    ...
    <div className='max-w-[100%] lg:px-[40px] px-[20px] mx-auto lg:py-[40px] py-[20px] '>
    ...
    <div className='  hidden md:block max-w-[100%] lg:px-[40px] px-[20px] mx-auto '>
    ...
    {/* Listing section */}
    <div className='max-w-[100%] lg:px-[40px] px-[20px] mx-auto lg:py-[20px]'>
      <div className='flex justify-between'>
      <div className='w-[18%] mx-[2%] '>
        <form action="" className='p-[10px] border border-gray-500 rounded'> 
          <h1 className='text-[#2e2123] text-2xl font-semibold py-[10px]'>Category</h1>
